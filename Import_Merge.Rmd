...
NSDUH_2015_small =
  PUF2015_021518 %>% 
  subset(select = c(QUESTID2, MEDMJST2, ircigfm, iralcfm, AGE2, irsex, NEWRACE2, PDEN10))
...
NSDUH_2018_small =
  PUF2018_100819 %>% 
  subset(select = c(QUESTID2, MEDMJPA2, ircigfm, iralcfm, AGE2, irsex, NEWRACE2, PDEN10)) %>% 
